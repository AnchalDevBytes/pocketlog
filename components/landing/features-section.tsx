...
const features = [
  ...
  },
  {
    ...
    description:
      "Set and track budgets with visual progress indicators and smart notifications.",
  },
  {
    icon: TrendingUp,
  ...
  },
  {
    ...
    title: "Export Data",
    description:
      "Export your financial data in multiple formats for external analysis.",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
            ...
            financial life with ease and confidence.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-slate-50 dark:bg-slate-700 p-8 rounded-2xl hover:shadow-lg transition-shadow duration-300 flex gap-5"
            >
              <div className="bg-blue-100 dark:bg-blue-900 w-12 h-12 rounded-xl flex items-center justify-center mb-6">
                <feature.icon className="h-6 w-16 text-blue-600 dark:text-blue-400" />
              </div>
              <div>

        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <CardTitle className="md:hidden">Insights</CardTitle>
            </div>
            <Button
          ...
          <CardDescription>
            Get AI-powered analysis of your spending patterns and personalized
            recommendations
          </CardDescription>
        </CardHeader>
              ...
              <div className="text-center p-4 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-lg">
                ...
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <Badge variant="secondary">
                    {getHealthScoreLabel(insights.financialHealthScore)}
                  </Badge>
                </div>
              </div>

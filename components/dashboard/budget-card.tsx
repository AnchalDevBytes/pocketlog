      ...
      <Card className="hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2 mt-1">
                  ...
                  <Badge
                    variant={isOverBudget ? "destructive" : isExpired ? "secondary" : "default"}
                    className="text-xs"
                  >
                    {getStatusText()}
                  </Badge>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Progress value={Math.min(progress, 100)} className={`h-3 ${isOverBudget ? "bg-red-100" : ""}`} />
          ...
          {isOverBudget && (
            <div className="flex items-center space-x-2 p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
              ...
              <p className="text-sm text-red-600 dark:text-red-400">
                You've exceeded this budget by {formatCurrency(budget.spent - budget.amount)}
              </p>
            </div>
          )}
          ...
          <div className="pt-2 border-t">
            <div className="grid grid-cols-2 gap-4 text-center">
              <div>
                <p className="text-xs text-slate-600 dark:text-slate-400">Daily Average</p>
